...
The embedded GIF is recorded from the actual `diffnotes` TUI and uses this repository as the review target. It walks through opening unstaged changes, adding inline comments, folding to comment context, and copying the agent-ready review text.
